...
> 当前开发阶段：**阶段 05（查询 API、筛选、搜索与分页，代码已实现待数据库验收）**。实时采集、AI、去重、聚类与生产评分流水线尚未实现；当前仍是 PostgreSQL Seed 数据版本。
...
- [ ] 阶段 05：新闻 API / 筛选 / 搜索 / 分页（代码完成，待 PostgreSQL 集成验收）
- [ ] 阶段 06+：采集 / AI / 去重 / 聚类 / 评分 / 日报 / 后台 / 部署
